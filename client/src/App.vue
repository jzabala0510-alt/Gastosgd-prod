    ...
    <template v-if="auth.isAuth">
      <header class="topbar">
        ...
        <nav class="topbar__nav">
          ...
          <router-link v-if="auth.esAnalista" to="/gastos" :class="{ active: $route.path.startsWith('/gastos') || $route.path.startsWith('/factura') }">Gastos<span v-if="notif.devueltas + notif.rechazadas" class="nav-badge nav-badge--red">{{ notif.devueltas + notif.rechazadas }}</span><span v-if="notif.analista" class="nav-badge nav-badge--green">{{ notif.analista }}</span></router-link>
